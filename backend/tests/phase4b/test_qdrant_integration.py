...
# Try to import real qdrant_client, set availability flag
try:
...
class TestQdrantConnection:
    ...
    def qdrant_client(self):
        ...
        # Try to connect to Qdrant container with timeout
        try:
    ...
    def test_qdrant_service_health(self, qdrant_client):
        ...
        # Connection already tested in fixture, just verify cluster info
...
class TestQdrantServiceIntegration:
    ...
    def test_qdrant_client_configuration(self):
        ...
        configs = [
            ...
            {"host": "qdrant", "port": 6333, "timeout": 5},  # Docker container name
        ]
